...
class WarmupMultiStepLR(torch.optim.lr_scheduler._LRScheduler):
    ...
    def get_lr(self):
        ...
        print("learing rate be like", list, len(list))
    ...
    with torch.no_grad():
        for loader_id, loader in enumerate(loaders):
            for data in loader:
                ...
                features = model(images) #changes here
...
def main(args):
    ...
    # print("query_loader", len(query_loader))
    # for item in range(10):
    #     print(query_loader[item][3])
    # print("gallery_loader", len(gallery_loader))
    # for item in range(10):
    #     print(gallery_loader[item][3])
    # print("propagate_loader", len(propagate_loader))
    # for item in range(10):
    #     print(propagate_loader[item][3])    
    ...
    # changes here
    lr_scheduler = WarmupMultiStepLR(optimizer, args.milestones, gamma=0.1, warmup_factor=0.01, warmup_iters=5)
    # lr_scheduler = GradualWarmupScheduler(optimizer, multiplier=8, total_epoch=5, after_scheduler=cosine_scheduler)
    # Trainer
    ...
    for epoch in range(args.epochs):
        ...
        # print("updated_label: ", updated_label, type(updated_label))
        # print("init_intra_id_feat: ", init_intra_id_feat, type(init_intra_id_feat))
        # update train loader
